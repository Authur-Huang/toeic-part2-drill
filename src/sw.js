...
var SHELL = 'p2-shell-v21';  // v21: 2026-09-01 Part 1 24 -> 96
// ⚠ AUDIO1 不動：這次只**新增** p1-025~096 的 mp3，舊的 24 支一個字都沒改。
//   版本号加上去反而會把手機已經拓好的 2 MB 全清掉、重抓一次。
// v20：2026-08-30 複習佇列不套難度篩選；Part 3/4 補「只練沒做過的」
// 兩個音檔快取分開，對應設定頁的分包下載。
